    ...
    <>
      ...
      <div className="bg-[#CAFFFF] py-3 px-3 w-full">
        <h1 className=" text-black text-xl font-semibold font-['Poppins'] leading-[52.01px]">
          Approved Listing Email Message
        </h1>
      </div>
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email subject for approved listing
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email content for listing approved
          </p>
        </div>
      ...
      <div className="bg-[#CAFFFF] py-3 px-3 w-full mt-6">
        <h1 className=" text-black text-xl font-semibold font-['Poppins'] leading-[52.01px]">
          Disapproved Listing Email Message
        </h1>
      </div>
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email subject for disapproved listing
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email content for disapproved listing
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email subject for expired listing
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email content for listing expired
          </p>
        </div>
