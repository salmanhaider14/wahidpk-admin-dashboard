    ...
    <>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email subject for New Lead Addition
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            Email content for New Lead Addition
          </p>
        </div>
      ...
      <div className="bg-[#CAFFFF] py-3 px-3 w-full mt-10">
        <h1 className=" text-black text-xl font-semibold font-['Poppins'] leading-[52.01px]">
          Lead Center SMS Notifications
        </h1>
      </div>
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            SMS subject for New Lead Addition
          </p>
        </div>
      ...
      <div className="flex  w-full flex-col md:flex-row sm:items-start md:items-center md:gap-[200px] mt-20">
        <div className="flex flex-col gap-1  items-start">
          ...
          <p className="text-neutral-400 text-[#8E8E93] text-[14.38px] font-bold font-['Poppins']">
            SMS content for New Lead Addition
          </p>
        </div>
...
export default LeadCenterNotifications;
